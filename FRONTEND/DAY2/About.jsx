...
const Dash = () => {
  ...
  return (
    ...
    <div className="comp2">
        <h1>The company is owned and operated by <span>SOUNDER</span> . As an experienced and passionate event decorator, <span>SOUNDER</span>  brings a wealth of creativity and expertise to every project. With a background in design and a keen eye for detail, <span>SOUNDER</span> has curated a team of skilled professionals who share a common vision of delivering extraordinary event experiences.
